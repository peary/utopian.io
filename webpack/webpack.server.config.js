  ...
  plugins: [
    new webpack.DefinePlugin({
      'process.env': {
        ...
        STEEMCONNECT_REDIRECT_URL: JSON.stringify(process.env.STEEMCONNECT_REDIRECT_URL || 'https://blockdoc.pro/callback'),
        STEEM_NODE: JSON.stringify(process.env.STEEM_NODE || 'https://api.steemit.com'),
        SERVER_SSL_CERT: JSON.stringify(process.env.SERVER_SSL_CERT || 'fullchain.pem'),
        SERVER_SSL_KEY: JSON.stringify(process.env.SERVER_SSL_KEY || 'privkey.pem'),
        UTOPIAN_CATEGORY: JSON.stringify(process.env.UTOPIAN_CATEGORY || 'blockdoc'),
        UTOPIAN_LANDING_URL: JSON.stringify(process.env.UTOPIAN_LANDING_URL || 'http://join.blockdoc.pro'),
        UTOPIAN_API: JSON.stringify(process.env.UTOPIAN_API || 'https://api.blockdoc.pro/api/'),
        ...
        UTOPIAN_GITHUB_REDIRECT_URL: JSON.stringify(process.env.UTOPIAN_GITHUB_REDIRECT_URL || 'https://blockdoc.pro/github/callback'),
